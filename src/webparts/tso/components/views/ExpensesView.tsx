  ...
  return (
    <div>
      ...
      <Modal show={isModalOpen} title={editingExpense ? "Edit Expense" : "Add New Expense"} onClose={handleCloseModal}>
        <form onSubmit={(e) => { e.preventDefault(); handleSubmit(); }} style={{ overflow: "visible" }}>
          <div className="row">
          ...
          {/* File Upload */}
          <div className="mb-3">
            <label className="form-label fw-semibold">Attachment (Any File Type)</label>
            ...
            {previewUrl && (
              <div className="mt-3">
                ...
                <button
                  type="button"
                  onClick={() => { setSelectedFile(null); setPreviewUrl(null); setIsImage(false); }}
